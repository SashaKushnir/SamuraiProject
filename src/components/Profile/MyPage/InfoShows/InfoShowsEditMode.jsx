...
import { maxLengthCreator } from '../../../FormControl/Validators/Validators'
    ...
    return <form className={styles.myWrapper} onSubmit={props.handleSubmit}>
        <div >
            ...
            <div>
                ...
                <div className={styles.marginator}>
                    <button onClick={props.deActivateEditMode}>Cancel</button>
        ...
        <div ><b>Contacts: </b><div>{contactsWithInputs}</div></div>
    </form>
}
InfoShowsEditMode = reduxForm({ form: 'editProfile' })(InfoShowsEditMode)

export default InfoShowsEditMode